# Домашнее задание к занятию "`Git`" - `Дунаев Дмитрий`
...
---
### Решение 1
[Ссылка на первый коммит](https://github.com/duskdemon/sys-29-hw-8.01/commit/212c96998d89235cfe0da538e71f03828400f970)
